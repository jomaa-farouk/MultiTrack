...
==============> Avant chaque bloc de test, on efface la table et on insère les mêmes données afin que les tests peuvent avoir les mêmes conditions d'exécution à chaque fois.
